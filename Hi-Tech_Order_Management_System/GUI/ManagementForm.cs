...
namespace Hi_Tech_Order_Management_System.GUI
{
    public partial class ManagementForm : Form
    {
            ...
            try
            {
                ...
                switch (selectedIndex)
                {
                    ...
                    case 3:
                        ...
                        List<Employee> listTemp2 = tempEmp2.SearchEmployee(textBoxSearch.Text.Trim());
                        listView1.Items.Clear();
                        if (listTemp2 != null)
                        {
        ...
        private void addButton_Click(object sender, EventArgs e)
        {
            ...
            usr.SaveUser(usr);
            MessageBox.Show("User record has been saved successfully.", "User Saved", MessageBoxButtons.OK, MessageBoxIcon.Information);
            ...
            try
            {
                ...
                switch (selectedIndex)
                {
                    case 1:
                        ...
                        User usr = new User();
                        usr = usr.SearchUser(Convert.ToInt32(textBoxSearch.Text.Trim()));
                        if (usr != null)
                        {
                    ...
                    case 2:
                        ...
                        List<User> listTemp = tempUsr.SearchUser(textBoxSearch.Text.Trim());
                        listView1.Items.Clear();
                        if (listTemp != null)
                        {
                            foreach (User anUsr in listTemp)
                            {
                    ...
                    case 3:
                        ...
                        List<User> listTemp2 = tempEmp2.SearchUser(textBoxSearch.Text.Trim());
                        listView1.Items.Clear();
                        if (listTemp2 != null)
                        {
        ...
        private void comboBox1_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            {
                case 1:
                    labelMessage.Text = "Please enter User Id";
                    textBoxSearch.Clear();
                    textBoxSearch.Focus();
                    break;
                case 2:
